...
// ========== 세금계산서 관리 ==========
// 세금계산서 전용 상태/함수(발행 목록 조회, 초안 작성, 발급 처리, 엑셀 저장 등)는
// tax-invoice.js로 옮겼다(§코드 쪼개기 1차 — 테스트 저장소 한정). 단, 아래 헬퍼들은
// 미수금/월매출 화면과도 공유해서 쓰이므로 여기 그대로 남겨둔다: readWorkDataStorage,
...
// (getTaxInvoiceSourceGroups부터 exportTaxInvoiceCsv까지 → tax-invoice.js)
