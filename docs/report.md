...
```
/* 월 이동기·요약 카드·설정 헤더·아이콘 버튼·토글·입력 기본형 — main-calendar.css에서 옮김. App.jsx가 app-shell-base.css 다음에 import. 여러 화면이 공유하는 CSS라 200줄 초과(215줄)를 예외로 둠 — 다음에 또 추가할 땐 분할설계 먼저 보고. */
```
