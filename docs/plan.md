...
기준 문서: `docs/research.md` (구 `migration-research.md`, 2026-09-15 `docs/archive/`에서 이동). 이 계획은 바닐라 함수를 JSX로 옮기는 번역이 아니라, **같은 도메인 규칙·같은 저장소 계약**을 **선언형 UI + 명시적 스토어**로 다시 짜는 설계다.
