...
- §15 슬라이스 E — 연동기사·차주 각 계정 거래처 고정노선 설정. 브라우저
  검증 때마다 원인 추정→수정 3차례 **매번 빗나감** → 착수 시 하루 잡고
  처음부터 재조사, 기존 추정은 신뢰 금지. `LinkedDriverClientsPage.jsx`
  수정 등은 working copy에 미커밋 잔여물로 남아있으나 신뢰하지 말 것.
