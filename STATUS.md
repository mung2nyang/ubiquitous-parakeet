...
> 최종 갱신: 2026-09-24 (0-1 개인정보 화면 로그인 상태 텍스트 입력 오류 수정 `[x]` — react-app `914431c`.
> 앞서 ③ 11-5·11-6 `[x]`(`41f9539`)·② 5-5 `[x]`(`550bca5`)·① 11-7 `[x]`(`fc4ec83`). 진행 중인 슬라이스 없음. 다음은 0-2(대표자명·예금주 서버 저장), 그다음 ④.)
...
1·2번(② 5-5, ③ 11-5·11-6) `[x]` 완료, 보리 지시 0-1(개인정보 로그인 입력 오류)도 `[x]` 완료. 지금은 0-2(대표자·예금주 서버 저장) — DB에 `profiles.business_representative`·`account_holder` 칸 추가 + 저장·복원 코드(진단 결과는 `docs/roadmap.md` 0-2).
