...
> 삭제(`3bc860a`) `[x]` push·CI 초록·보리 최종 승인 완료. 남은 조치·기능 작업은
...
- 이관 완전성 감사 조치 6건(5-5·10-7·11-1·11-5·11-6·11-7) — `docs/roadmap.md`,
  근거는 `docs/migration-audit.md`. 별도로 이관 감사 B(계산 로직 수치 대조, 미실시)와
  고정노선 무스코프 호출부 전수 조사(읽기 전용, 확정 규칙은 `docs/sot.md`에 기록).
