...
> 전수 조사 `[x]`(`docs/scope-audit.md`, 스코프 수정 2묶음 도출). 남은 조치·기능 작업은
> `docs/roadmap.md`. 진행 중인 슬라이스 없음)
...
- 이관 완전성 감사 조치 6건(5-5·10-7·11-1·11-5·11-6·11-7) — `docs/roadmap.md`,
  근거는 `docs/migration-audit.md`. 이관 감사 B(계산 로직 수치 대조)는 수행 AI가 결과
  `docs/finance-parity.md`를 만들었고 보리 검토 대기. 스코프 조사에서 나온 수정 2묶음(연동기사 본인
  달력·매출 / 운송비 내역서)은 `docs/roadmap.md`.
