...
- **§1 홈 캘린더 — 수정 5건 `[~]`.** react-app `fe98184` 커밋·push 완료,
  CI "verify" 초록(run `34189318780`, headSha 일치), 감시관 §5 리뷰 통과
  (범위 4파일 정확히 일치·타입꼼수 0·문서 diff 0·테스트 훼손 0). **보리
  브라우저 실검증 후 `[x]` 승인 대기 중.** 상세는 `docs/report.md`.
