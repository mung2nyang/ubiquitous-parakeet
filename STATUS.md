...
strict-inventory 직접 재실행해 395·`syncExpenseRecords.js(` 0줄·`lib/expenses.js(` 5줄
불변·561/135 확인)·보리 최종 `[x]`.
- `// @ts-check` + `CarLike`/`ExpenseItem` 재사용 + 함수 5개 JSDoc + `expenseSyncInputs`
